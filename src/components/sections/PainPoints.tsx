  ...
  return (
    <section className="relative bg-noise py-24 lg:py-32 bg-motim-bg">
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <h2 className="reveal font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
          Ter presença nas redes sociais
          <br className="hidden sm:block" />
          <span className="gradient-accent-text">não significa crescer.</span>
        </h2>
        ...
        <p className="reveal text-white text-base md:text-lg leading-relaxed max-w-3xl mx-auto mb-14">
        ...
        <div className="reveal flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
          {painPoints.map((pain, i) => (
            <div
              key={i}
              className="inline-flex items-center gap-2 bg-motim-surface border border-motim-border rounded-full px-5 py-2.5 text-sm text-motim-muted hover:border-[#FF6B35]/40 hover:text-white transition-all duration-300"
            >
